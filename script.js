document.addEventListener("DOMContentLoaded", () => {
    ...
    // 🔥 NUEVO: Zoom dinámico (Más grande en cel para que se lea mejor)
    let currentScale = window.innerWidth < 600 ? 1.5 : 1.2;
    ...
    books.forEach(book => {
        book.addEventListener("click", () => {
            ...
            pdfjsLib.getDocument(currentPdfUrl).promise.then(pdfDoc_ => {
                ...
                // Si la página guardada es mayor al total del libro (por si acaso), lo mandamos a la 1
                ...
                currentScale = window.innerWidth < 600 ? 1.5 : 1.2; 
            }).catch(err => {
    ...
    document.getElementById("btnGuardar").addEventListener("click", () => {
        if(currentPdfUrl) {
            ...
            // Efecto visual en el botón para confirmar
            ...
            setTimeout(() => {
                ...
                btn.style.background = ""; // Vuelve a la clase CSS
            }, 1500);
        }
    });
    ...
    btnDescanso.addEventListener("click", () => {
        ...
        btnDescanso.textContent = visor.classList.contains("modo-descanso") ? "☀️ MODO NORMAL" : "🌙 DESCANSO";
    });
